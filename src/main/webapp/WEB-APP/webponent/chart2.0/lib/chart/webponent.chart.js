	...
	(function() {
		...
		var defaultStyles = {
				...
				graph: {
					...
					line: {
						top: { color: '#cccccc', width: 1, opacity: 1 },
						left: { color: '#ddd', width: 0, opacity: 1 },
						right: { color: '#ddd', width: 0, opacity: 1 },
						bottom: { color: '#cccccc', width: 1, opacity: 1 }
					}
				},
				yAxis: {
					...
					text: {family: 'Dotum', size: 12, color: '#666', align: 'right', style: 'normal', opacity: 1},
				...
				xAxis: {
					...
					text: {family: 'Dotum', size: 12, color: '#666', align: 'center', style: 'normal', opacity: 1},
				...
				tip: {
					...
					text: {
						color: '#fff', family: 'Dotum', style: 'normal',  size: 12
					}
				}
		};
		/**
			...
			**************************/
			...
			DRAWSERIES.drawcolumn = function(_serieskey, _options, _styles, _series){
				...
				var defaultStyles = {
					...
					text: {
						...
						family: 'Dotum', size: 12, color: '#666666', align: 'center',
			...
			DRAWSERIES.drawplot = function(_serieskey, _options, _styles, _series){
				...
				var defaultStyles = {
					...
					text: {
						use: false, family: 'Dotum', color: '#666666', align: 'center', style: 'normal', opacity: 1, format: null
					}
				};
				var self = {};
